    <footer id="footer">
        <div id="footer">
                ...
                <ul id="notifications">
                        ...
                        <li>
                                <a href="#" class="notificationIcons"><img src="<?php echo base_url(); ?>images/facebook.png" alt="" />
                                        <span> <!-- The span is the text appearing on hover, use the notificationIcons class in the link -->
                                                <img src="<?php echo base_url(); ?>images/defaultProfileImage.png" style="float:left;width:24px;margin-right:5px;"/>
